...
<div class="container">
  ...
  <h2 class="login-header">Reserva con la cuenta de la Universidad</h2>

  <form class="login-container" action="<?php echo base_url("index.php/Welcome/registrar");?>" method="post">
    <p><input type="email" name="email" placeholder="example@est.ups.edu.ec" required="true"></p>
...
<div class="footer">
          <div class="row" style="text-align:center">
                <div class="col-lg-12">
                    ...
                    <p style="font-size: 16px; color: white" >Desarrollado por <a style="color: lightblue" href="http://www.softupcloud.com">SoftupCloud</a></em></p>
                </div>
            </div>
</div>
